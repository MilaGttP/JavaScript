...
`calculateEngravingPrice(message, pricePerWord)`, що приймає рядок (в рядку будуть
...
- Під час завантаження сторінки користувачеві пропонується в `prompt` ввести число.
